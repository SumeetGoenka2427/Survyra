<div class="mb-3">
    ...
    <div class="d-flex gap-3 image-choice-carousel" style="overflow-x: auto; scroll-snap-type: x mandatory; padding-bottom: .5rem;">
        @foreach ($options as $index => $option)
            ...
            @endphp
            <div style="flex: 0 0 auto; width: 160px; scroll-snap-align: start;">
                <label class="image-choice-card d-block border rounded-3 p-2 text-center" style="cursor: pointer;">
                    ...
                    <div class="image-wrapper mb-2">
                        @if ($imageUrl)
                            <img src="{{ $imageUrl }}" alt="{{ $label }}" class="img-fluid rounded" style="height: 140px; object-fit: cover; width: 100%;">
                        @else
                            <div class="bg-light d-flex align-items-center justify-content-center rounded" style="height: 140px;">
