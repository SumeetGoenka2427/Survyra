<x-public-layout
    title="Survyra"
    description="Survyra is customer survey software for salons, restaurants, clinics and local businesses. Build smart surveys, collect QR and link feedback, and turn happy customers into 5-star reviews."
>
    <script type="application/ld+json">
        {!! json_encode([
            '@@context' => 'https://schema.org',
            '@type' => 'Service',
            'serviceType' => 'Customer survey and feedback software',
            'provider' => ['@type' => 'Organization', 'name' => 'Survyra'],
            'areaServed' => 'IN',
            'audience' => ['@type' => 'Audience', 'audienceType' => 'Small and local businesses'],
            'description' => 'Survyra is customer survey software that combines QR-based feedback surveys, a review-growth funnel and an analytics dashboard for small businesses.',
    ...
    <header class="sv-hero">
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <span class="sv-eyebrow sv-anim">Customer Survey Software for Salons, Restaurants, Clinics &amp; Local Businesses</span>
                    <h1 class="mt-3 mb-3 sv-anim sv-anim-delay-1">Smart Customer Surveys That Turn Feedback Into 5-Star Reviews</h1>
                    <p class="lead sv-anim sv-anim-delay-2">Survyra is customer survey software built for local businesses. Create a smart survey in minutes, collect honest feedback by QR code or link, catch unhappy customers before they walk away, and turn every great experience into a public review &mdash; all from one simple dashboard.</p>
                ...
                <div class="col-lg-6">
                    <div class="sv-hero-visual sv-anim sv-anim-delay-2">
                        <div class="sv-hero-flow-labels d-none d-md-flex">
                            <span style="--i:0">QR</span>
                            <span style="--i:1">Survey</span>
                            <span style="--i:2">Review</span>
                            <span style="--i:3">Analytics</span>
                        </div>
                        <div class="sv-demo-frame">
                            ...
                            <div class="p-4">
                                ...
                                <div class="fw-semibold mb-3" style="font-family:'Poppins',sans-serif;">Customer Experience Survey</div>
    ...
    <div class="sv-trust-strip sv-reveal">
        <div class="container">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-4">
                ...
                <span class="small text-muted-2"><i class="bi bi-check-circle-fill text-accent me-1"></i>Actionable analytics</span>
    ...
    <section id="what-we-do" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 680px;">
                ...
                <h2 class="sv-section-title">Everything You Need to Run Better Customer Surveys</h2>
                <p class="text-muted-2 mt-2">Not a generic form builder &mdash; purpose-built survey software focused entirely on understanding your customers.</p>
            </div>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="sv-service-card sv-reveal">
                        <div class="sv-service-icon"><i class="bi bi-clipboard-data"></i></div>
                        <h3 class="h5">Smart Survey Builder</h3>
                        <p class="text-muted-2 mb-0">Create mobile-friendly customer surveys with multiple question types and branching logic that adapts to every answer.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="sv-service-card sv-reveal sv-reveal-delay-1">
                        <div class="sv-service-icon"><i class="bi bi-qr-code"></i></div>
                        <h3 class="h5">QR &amp; Link Distribution</h3>
                        <p class="text-muted-2 mb-0">Share your survey instantly with a QR code or link &mdash; no app, download or account required for customers.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="sv-service-card sv-reveal sv-reveal-delay-2">
                        ...
                        <p class="text-muted-2 mb-0">Turn survey responses into momentum &mdash; give every happy customer an easy, well-timed way to leave a public review.</p>
                    </div>
                </div>
            </div>
            <p class="text-center fw-semibold mt-5 mb-0 sv-reveal">One simple platform to run customer surveys and turn feedback into growth. No complicated software.</p>
        </div>
    </section>
            ...
            <div class="sv-why-strip sv-reveal">
                <div class="sv-why-item">
                    ...
                    <div>
                        ...
                        <div class="text-muted-2 small">No app. No login. Just scan the survey and respond.</div>
                    </div>
                </div>
                <div class="sv-why-item">
                    ...
                    <div>
                        ...
                        <div class="text-muted-2 small">One simple dashboard for every survey response and review.</div>
                    </div>
                </div>
                <div class="sv-why-item">
                    ...
                    <div>
                        ...
                        <div class="text-muted-2 small">Survey templates designed around salons, restaurants, clinics and service businesses.</div>
                    </div>
                </div>
                <div class="sv-why-item">
                    ...
                    <div>
                        ...
                        <div class="text-muted-2 small">Ratings, trends and survey results in one dashboard you'll actually check.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center sv-reveal">
                    ...
                    <h2 class="sv-section-title">Why Customer Surveys Matter More Than Ever</h2>
                    <p class="lead mt-3 text-muted-2">Most small businesses hear from customers every day &mdash; but without a simple survey in place, that feedback disappears the moment the customer walks out the door.</p>
                    <p class="text-muted-2">Survyra gives you a structured way to ask the right questions at the right moment, and see every answer in one place. Instead of guessing why a customer didn't return, you'll know. Instead of hoping for reviews, you'll have a survey process that asks for them at exactly the right time.</p>
                    <p class="fw-semibold mt-4 mb-0">Our goal: help small businesses use customer surveys to make better decisions and grow sustainably.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="how-it-works" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 640px;">
                ...
                <h2 class="sv-section-title">The Survey Process, From Question to Insight</h2>
                <p class="text-muted-2 mt-2">From a customer visit to a 5-star review, in five simple steps.</p>
            </div>
    ...
    <section id="try-demo" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 640px;">
                ...
                <p class="text-muted-2 mt-2">A live, working preview of the customer survey &mdash; rate it below and watch the flow branch in real time.</p>
            </div>
            ...
            <noscript>
                <style>[data-demo-widget] { display: none; }</style>
                <div class="sv-noscript-note">
                    <p class="fw-semibold mb-2">This live preview needs JavaScript.</p>
                    <p class="text-muted-2 small mb-3">Enable JavaScript to try the interactive demo, or just reach out and we'll walk you through it.</p>
                    <a href="#demo" class="btn btn-primary btn-sm">Get My Free Demo</a>
                </div>
            </noscript>
            ...
            <div class="row g-4 mt-1 justify-content-center">
                <div class="col-md-6 col-lg-5 sv-reveal">
                ...
                <div class="col-md-6 col-lg-5 sv-reveal sv-reveal-delay-1">
    ...
    <section id="before-after" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 680px;">
                ...
                <h2 class="sv-section-title">Stop Guessing What Your Customers Think &mdash; Start Asking</h2>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="sv-compare-card sv-reveal">
                        <div class="sv-compare-label sv-compare-bad"><i class="bi bi-x-circle-fill me-1"></i> Without a Customer Survey</div>
    ...
    <section id="review-funnel" class="sv-section sv-section-alt">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 680px;">
                <span class="sv-section-eyebrow">Turn Survey Feedback Into More Reviews</span>
    ...
    <section id="business-types" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 680px;">
                ...
                <h2 class="sv-section-title">Built for Businesses That Depend on Customer Insight</h2>
            </div>
            <div class="row g-4">
    ...
    <section id="differentiation" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 680px;">
                ...
                <p class="text-muted-2 mt-2">One simple survey system instead of managing multiple vendors.</p>
            </div>
                ...
                <table class="table sv-compare-table align-middle text-center mx-auto" style="max-width: 720px;">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">DIY Survey Builder</th>
                            <th scope="col">Manual / Paper Feedback</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <th scope="row" class="text-start fw-normal">Custom Survey Builder</th>
                            <td><i class="bi bi-check-circle-fill text-accent"></i></td>
                            <td><i class="bi bi-check-circle-fill text-accent"></i></td>
                            <td>&mdash;</td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-start fw-normal">Branching Logic &amp; Question Types</th>
                            <td><i class="bi bi-check-circle-fill text-accent"></i></td>
                            <td class="text-muted-2 small">Sometimes</td>
                            <td>&mdash;</td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-start fw-normal">QR Code Feedback</th>
                            <td><i class="bi bi-check-circle-fill text-accent"></i></td>
                            <td class="text-muted-2 small">Sometimes</td>
                            <td>&mdash;</td>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" class="text-start fw-normal">Built for Local Businesses</th>
                            <td><i class="bi bi-check-circle-fill text-accent"></i></td>
                            <td>&mdash;</td>
                            <td>&mdash;</td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-start fw-normal">Dashboard &amp; Analytics</th>
                            <td><i class="bi bi-check-circle-fill text-accent"></i></td>
                            <td class="text-muted-2 small">Sometimes</td>
                            <td>&mdash;</td>
                        </tr>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-5 sv-reveal">
                    ...
                    <p class="text-muted-2 mt-2">Everything below is included in the Growth plan &mdash; one price, no surprises.</p>
                </div>
                <div class="col-lg-7">
                    <div class="row sv-reveal sv-reveal-delay-1">
                        @foreach ([
                            'Custom survey builder', 'Branching logic', 'Multiple question types', 'Mobile-optimized surveys',
                            'QR code & shareable link', 'Feedback dashboard', 'Review-growth funnel', 'WhatsApp feedback requests',
                            'Response analytics', 'Export to PDF, Excel & CSV', 'Team access',
                        ] as $item)
    ...
    <section id="pricing" class="sv-section sv-section-alt">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 680px;">
                ...
                <h2 class="sv-section-title">Simple, Monthly Survey Software Pricing</h2>
                <p class="text-muted-2 mt-2">One plan for every business &mdash; no setup fees, no long-term contracts.</p>
            </div>
    ...
    <section id="timeline" class="sv-section">
        <div class="container">
            <div class="text-center mx-auto mb-5 sv-reveal" style="max-width: 640px;">
                ...
                <h2 class="sv-section-title">Your Survey Program, Live in Under a Week</h2>
            </div>
            <div class="sv-timeline sv-reveal">
                ...
                <div class="sv-timeline-item"><div class="sv-timeline-day">Day 2</div><div>Survey Setup</div></div>
                <div class="sv-timeline-item"><div class="sv-timeline-day">Day 3</div><div>QR + Review Funnel</div></div>
                <div class="sv-timeline-item"><div class="sv-timeline-day">Day 4</div><div>Branding</div></div>
                <div class="sv-timeline-item"><div class="sv-timeline-day">Day 5</div><div>Testing</div></div>
                <div class="sv-timeline-item sv-timeline-final"><div class="sv-timeline-day">Day 6</div><div><i class="bi bi-rocket-takeoff-fill text-accent me-1"></i>Go Live</div></div>
            </div>
        </div>
    </section>
    ...
    <section id="glance" class="sv-section">
        <div class="container">
            ...
            <div class="row g-3 justify-content-center sv-reveal" style="max-width: 900px; margin: 0 auto;">
                <div class="col-md-6 col-lg-4"><div class="sv-glance-item"><div class="sv-glance-q">What is Survyra?</div><div class="text-muted-2 small">Customer survey software with review growth and analytics for small businesses.</div></div></div>
                ...
                <div class="col-md-6 col-lg-4"><div class="sv-glance-item"><div class="sv-glance-q">What does it include?</div><div class="text-muted-2 small">Custom surveys, QR feedback, review tools and analytics.</div></div></div>
                ...
                <div class="col-md-6 col-lg-4"><div class="sv-glance-item"><div class="sv-glance-q">Can I customize my surveys?</div><div class="text-muted-2 small">Yes, with your own questions, question types and branching logic.</div></div></div>
                <div class="col-md-6 col-lg-4"><div class="sv-glance-item"><div class="sv-glance-q">Starting price?</div><div class="text-muted-2 small">₹999/month, with plans for every business size.</div></div></div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5">
                    ...
                    <h2 class="sv-section-title text-white">Ready to Start Collecting Smarter Customer Surveys?</h2>
                    <p class="mt-3" style="color: rgba(255,255,255,0.75);">Tell us a bit about your business and we'll send over a quick survey walkthrough &mdash; no commitment, no pressure.</p>
                    <ul class="list-unstyled mt-4" style="color: rgba(255,255,255,0.85);">
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-accent me-2"></i>A short recorded survey walkthrough within 24 hours</li>
                    ...
                    <div class="sv-lead-card sv-reveal">
                        <form method="POST" action="{{ route('leads.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                @foreach (['surveys' => 'Custom Surveys', 'feedback' => 'Customer Feedback', 'reviews' => 'Review Growth', 'analytics' => 'Analytics & Reporting'] as $value => $label)
                                    <div class="form-check form-check-inline">
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6">
                    <div class="mb-2"><x-brand-mark variant="dark" /></div>
                    <p class="small mb-0">Customer survey software that turns feedback into 5-star reviews and better business decisions &mdash; built for salons, restaurants, clinics and local businesses.</p>
                </div>
                <div class="col-lg-2 col-md-6">
                    <div class="sv-footer-heading">Product</div>
                    <ul class="list-unstyled small">
                        <li><a href="#what-we-do">Customer Surveys</a></li>
                        <li><a href="#how-it-works">QR Feedback</a></li>
                        <li><a href="#review-funnel">Review Growth</a></li>
                        <li><a href="#glance">Analytics</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-6">
    ...
    <div class="sv-sticky-cta d-md-none" data-sticky-cta>
        <a href="#demo" class="btn btn-accent w-100">Get My Free Demo</a>
    </div>
